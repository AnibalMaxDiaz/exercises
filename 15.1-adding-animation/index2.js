...
// This part catch the parameter of the other two functions and add a class for changing the style of the button or letter pressed with the classlist.add metod
function effect(y){
  var classOfElement = document.querySelector("." + y);
  console.log(classOfElement);
  classOfElement.classList.add("pressed");
  // here we set a delay and tell to the function what to do when the time´s up, with th setTimeOut metod and its 2 parameters, first an anonymous function with the instruction to do and second the time in ms
  setTimeout(function(){
    classOfElement.classList.remove("pressed");
  }, 100)
}
